...
keywords: data collector, stout, fsx, fsx-netapp
...
This data collector acquires inventory and performance data from FSx-NetApp. This data collector also creates a record in the cluster application registry to accelerate support.
