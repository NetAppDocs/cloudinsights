...
|Can view and modify Alerts and Forensics. User role can change alert status, add a note, take snapshots manually, and manage user blocking.
...
|Can view Alerts and Forensics. Guest role cannot change alert status, add a note, take snapshots manually, or manage user blocking.
