...
|Can perform all User/Author functions including managing Reporting APIs, as well as all administrative tasks such as configuration of reports, and the shutdown and restart of reporting tasks.
