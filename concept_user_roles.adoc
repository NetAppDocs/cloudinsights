...
keywords: user role, roles, guest, user, administrator, SSO, Federate, federation, identity, single sign-on, Account Owner, Reporting, Cloud Secure
summary: Cloud Insights provides multiple user account roles with different permission levels.
...
|User	
|Can view and modify dashboards, queries, annotations, annotation rules, and applications, and view monitors/alerts and device resolution.
|n/a	
...
|Alerts and Monitors: Create/Modify/Delete|Y|N|N
|Alerts and Monitors: View|Y|Y|Y
...
|Device Resolution: Create/Modify/Delete|Y|Y|N
|Device Resolution: View|Y|Y|Y
