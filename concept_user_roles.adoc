...
keywords: roles, guest, user, administrator, SSO, single sign-on, Federate, federation, identity, single sign-on, Account Owner
...
NOTE: It is strongly recommended to have at least two Account Owners for each Cloud Insights environment. 
