...
|User	
|Can view and modify dashboards, queries, alerts, annotations, annotation rules, and applications, and view monitors and device resolution.
|n/a	
...
|Alerts*: Create/Modify/Delete|Y|N|N
|Alerts*: View|Y|Y|Y
...
|Device Resolution: Create/Modify/Delete|Y|N|N
