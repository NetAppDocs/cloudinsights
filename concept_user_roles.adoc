...
|Acquisition Units: Add/Modify/Clone/Delete|Y|N|N
|Alerts*/Policies: Create/Modify/Delete|Y|N|N
|Alerts*/Policies: View|Y|Y|N
|Annotation Rules|Y|Y|N
...
|Audit: View|Y|N|N
|Dashboards: Create/Modify/Delete|Y|N|N
...
|Reports*: Create/Modify/Delete/Schedule|Y|N|N
