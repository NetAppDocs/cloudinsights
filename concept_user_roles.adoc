...
keywords: roles, guest, user, administrator, SSO, Federate, Account Owner, Reporting, Cloud Secure
summary: Cloud Insights provides multiple user accounts with different permission levels. Account permissions can be set separately for Monitor & Optimize, Reporting, and Cloud Secure features.
---
