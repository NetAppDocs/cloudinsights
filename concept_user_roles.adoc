...
|Can view and manage Alerts, and view Forensics. User role can change alert status, add a note, take snapshots manually, and manage user access restriction.
...
|Can view Alerts and Forensics. Guest role cannot change alert status, add a note, take snapshots manually, or manage user access restriction.
