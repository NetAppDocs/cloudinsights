...
The *Admin > API Access* links contain documentation for the link:#API_Overview.html[*Assets/Import*] API. This documentation contains information on the .CSV file format. 
