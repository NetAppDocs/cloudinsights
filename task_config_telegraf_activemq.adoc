...
+
Select the Operating System or Platform on which you wish to install the data collector. 
+
If you haven't already configured an Agent for collection, or you wish to install an Agent for a different Operating System or Platform, click _Show Instructions_ to expand the link:task_config_telegraf_agent.html[Agent installation] instructions.
