...
|Filter VMs |Select CLUSTER, DATA CENTER, or ESX HOST, or you can choose to filter by TAG 
|Choose 'Exclude' or 'Include' to Specify a List|Create a filter list (ESX_HOST, CLUSTER, and DATACENTER only). 
