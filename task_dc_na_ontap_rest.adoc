...
Vserver: C1_sti241-vsim-osr003g_1709829808
                                 Second
...
----
Last login time: 3/22/2024 11:46:23
C1_sti241-vsim-osr003g_1709829808::> security login rest-role show -vserver C1_sti241-vsim-osr003g_1709829808 -role restRole
               Role                                    Access
Vserver        Name            API                     Level
----------     -------------   -------------------     ------
C1_sti241-vsim-osr003g_1709829808
               restRole        /api                    readonly
                               /api/cluster/agents     all
2 entries were displayed.

C1_sti241-vsim-osr003g_1709829808::> security login show -vserver C1_sti241-vsim-osr003g_1709829808 -user-or-group-name restUser
