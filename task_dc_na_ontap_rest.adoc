...
. Add the REST Collector, entering all the same user/permission/etc. you had for the previous collector.
.. or, enter information for a different user, if needed. For example, the user noted in the Permissions section above.
