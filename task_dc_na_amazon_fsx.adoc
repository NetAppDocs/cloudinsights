...
The Amazon FSx for NetApp ONTAP data collector reports the metrics link:https://docs.aws.amazon.com/fsx/latest/WindowsGuide/monitoring-cloudwatch.html[listed here].
