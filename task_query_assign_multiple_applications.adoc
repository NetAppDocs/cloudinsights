...
[.lead]
You can assign multiple link:[applications] to or remove multiple applications from assets by using a query instead of having to manually assign or remove them. 
...
NOTE: For environments with large amounts of related assets, inheritance of application assignments to related assets could take several minutes. Please allow more time for intheritance to occur if you have many related assets.
