...
This document provides the schema diagrams for the Data Warehouse Database. You can also download a file containing the link:CI-Schems-Tables.pdf[schema tables].
