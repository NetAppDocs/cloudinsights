...
This document provides the schema diagrams for the Reporting Database. 

//You can also download a file containing the link:ci_reporting_database_schema.pdf[schema tables].
