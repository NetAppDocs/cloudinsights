...
[.lead]
Cloud Insights' powerful API allows users to query the Cloud Insights Reporting database directly, without going through the Cloud Insights Analytics Reporting environment.
