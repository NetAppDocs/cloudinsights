...
To see a list of all async queries and which of them are ready, use the command _GET https://<Cloud Insights URL>/rest/v1/dwh-management/odata/dwh_custom/asyncList
