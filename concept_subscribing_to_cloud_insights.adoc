...
NOTE: It is important to keep in mind that you will be charged for  the new managed unit (MU) usage following the trial period, so be sure to plan accordingly.
