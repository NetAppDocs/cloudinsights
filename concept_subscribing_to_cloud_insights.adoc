...
+
WARNING: Inactive Cloud Insights free Basic Edition environments are deleted and their resources are reclaimed. An environment is considered inactive if there is no user activity for 90 consecutive days. 
+
...
Here are some of the key features available in Basic, Standard, and Premium Edition:
...
|VM, Cloud, & Service Metrics| - |&check;|&check;
|Monitors and Alerting| - |&check;|&check;
|Cloud Secure User Data Access Auditing| - | - |&check;
|Cloud Secure Insider Threat Detection| - | - |&check;
