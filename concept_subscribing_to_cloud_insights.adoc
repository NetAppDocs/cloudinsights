...
After you complete the AWS subscription process, you will be taken back to your Cloud Insights tenant. If the tenant is no longer active (for example, you have logged out), you will instead be taken to the Cloud Central login screen. When you log in to Cloud Insights again, your subscription will be active. 
...
If there is a problem and the Subscription process fails to complete correctly, you will still see the "Trial Version" banner when you log into your tenant. In this event, you can go to *Admin > Subscribe* and go through the subscription process again.
