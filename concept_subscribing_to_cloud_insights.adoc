...
In your environment it is possible to purchase multiple tiers of storage. Data Infrastructure Insights (DII) allows you to utilize your resources to their maximum potential before violating license compliance.
...
Here is the formula for calculating effective usage:
