...
NOTE: If you need additional time to evaluate Cloud Insights and your trial is set to expire in four days or less, you can extend your trial for an additional 14 days. You can extend the trial only once. You cannot extend if your trial has expired.
...
NOTE: The calculator is for estimation only. Your final pricing will be set in the AWS Marketplace page or in a conversation with your NetApp sales representative. 
