...
|Business Intelligence and Reporting&ast;&ast;&ast;| - | - |&check;
|===

&ast;Limited to 5 active custom monitors at a time
&ast;&ast;Limited APIs available
&ast;&ast;&ast;Available for environments of 500 managed units and larger
