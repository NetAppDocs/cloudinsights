...
Note that the following data collectors are metered at a different Raw TB to Managed Unit rate. Every 40TiB of unformatted capacity on these data collectors is charged as 1 Managed Unit (MU):
