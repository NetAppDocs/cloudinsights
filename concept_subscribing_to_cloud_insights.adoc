...
Once your subscription is active, you can view your subscription status, Managed Unit usage, and API Metering from the *Admin > Subscription* page.

image:Subscription_Summary_Tab.png[Subscription Status ] 
//image:Subscription_Status_Usage.png[Viewing your subscription status]

The *Summary* tab displays the following:

* Subscription serial number and current Edition
* Entitlement ID (if applicable) and subscription expiration date
* Links to modify your subscription, add an entitlement ID, or estimate cost changes
...
image:Subscription_DCUsage_Tab.png[Managed Units usage tab]
...
The *API Metering* tab gives you a view into usage of your configured APIs for the current month. 

image:API_Metering_Example_Screen.png[API Metering Screen showing DWH and Log INgestion data]
