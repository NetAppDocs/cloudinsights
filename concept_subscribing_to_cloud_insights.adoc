...
Cancellation of a subscription can be requested in the AWS Marketplace. For a cancelled subscription, Cloud Insights will display a message that your subscription is expired.
