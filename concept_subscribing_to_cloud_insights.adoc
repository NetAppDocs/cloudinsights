...
The Estimator also allow you to see how the numbers stack up if you choose to *Add On* to your current subscription, or if you choose to *Renew* your subscription for a 12- or 36-month term.
