...
NOTE: Keep in mind that you will be charged for the new managed unit (MU) usage following the trial period, so be sure to plan accordingly. When your module trial is edning, you will be notified if you will need to add more MUs to avoid ervice interruption.
