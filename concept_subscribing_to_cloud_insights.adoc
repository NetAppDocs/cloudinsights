...
Data Infrastructure Insights Observability meters usage according to the tier of storages in your environment. You may have storages that fall into one or more of these categories:
