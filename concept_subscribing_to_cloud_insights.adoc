...
* Total Managed Unit count allowed in your subscription
* Contract term (12 or 36 months)
* Managed Unit current usage

You can also see your Data Collectors installed, and the count of Managed Units for each.
