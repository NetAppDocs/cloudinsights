...
* Centos (64-bit): 7.2 through 7.9, Stream 8, Stream 9, including SELinux
* Debian (64-bit): 9 and 10, including SELinux
* Oracle Enterprise Linux (64-bit): 7.5 through 7.9, 8.1 through 8.4, including SELinux
* Red Hat Enterprise Linux (64-bit): 7.2 through 7.9, 8.1 through 8.7, 9.1 and 9.2, including SELinux
* Rocky 9.0, 9.1, including SELinux
* Ubuntu Server: 18.04, 20.04 and 22.04 LTS, including SELinux
