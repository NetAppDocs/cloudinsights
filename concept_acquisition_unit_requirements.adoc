...
* Centos (64-bit): 7.2 through 7.9, 8.1 through 8.3
* Debian (64-bit): 9 and 10
* Oracle Enterprise Linux (64-bit): 7.5 through 7.9, 8.1 through 8.3
* Red Hat Enterprise Linux (64-bit): 7.2 through 7.9, 8.1 through 8.3
