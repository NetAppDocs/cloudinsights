...
Icons within the circles represent different service types. Note that icons are only visible with circles if you have labeled the underlying objects <<workload-labels, see below>>.
