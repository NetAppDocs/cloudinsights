...
Icons within the circles represent different service types. These icons are visible if you have labeled the underlying objects <Link to labeling instructions, below?>. The size of the circle indicates the node size; note that these sizes are relative, your browser zoom level or screen size may affect actual circle sizes.
