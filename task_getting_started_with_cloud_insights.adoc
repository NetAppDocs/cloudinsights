...
At any point during the onboarding process, you can click on *Admin > User Management > +User* to link:concept_user_roles.html[invite additional users] to your Cloud Insights environment. In order not to interrupt the onboarding walkthrough, it is recommended to do this in a separate browser tab.
