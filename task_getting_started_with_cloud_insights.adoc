...
When you log in to your environment for the first time, you will be presented with a short video explaining the steps you will go through to begin collecting data.
