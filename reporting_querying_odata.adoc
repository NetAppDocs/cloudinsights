...
* All requests will start with the url _https://<Cloud Insights URL>/rest/v1/dwh-management/odata_
...
The URL for all calls is _https://<Cloud Insights URL>/rest/v1/dwh-management/odata_. 
