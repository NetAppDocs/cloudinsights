...
NOTE: If you have Cloud Insights Federal Edition, your installation and configurations instructions may be different than the instructions on this page. Follow the instructions in Cloud Insights to install the NetApp Kubernetes Monitoring Operator.
