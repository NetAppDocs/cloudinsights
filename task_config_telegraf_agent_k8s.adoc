...
Edit the monitoring-operator deployment in operator-config.yaml, and modify all image references to use your private Docker repository.
...
|Edit the netapp-monitoring-configuration agentconfiguration, and set _dockerMetricCollectionEnabled_ to false.  For more details, refer to the operator's link:telegraf_agent_k8s_config_options.html[configuration options]. 
