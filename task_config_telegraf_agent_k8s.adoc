...
.<<installing-the-agent, Install>> the current Operator. 
...
<<installing-the-agent, Install>> the current Operator. Use the same cluster name, and ensure you are pulling new container images if you have set up a custom repo.
