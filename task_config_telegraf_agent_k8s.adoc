...
* The host you will use for NKMO installation must have _kubectl_ configured to communicate with the target K8s cluster, and have Internet connectivity to your Cloud Insights environment.
...
NOTE: Your setup is incomplete intil you configure your proxy.
Link to below
...
To configure a proxy for the monitoring operator, perform the following steps after you install the NKMO.
...
If using a custom docker repository, do the following after installing the NKMO:
