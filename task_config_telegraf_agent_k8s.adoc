...
IMPORTANT: Read the link:/pre-requisites_for_k8s_operator.html[*Pre-Requisites* and *Pre-Knowledge*] documentation before installing or upgrading the NetApp Kubernetes Monitoring Operator.
