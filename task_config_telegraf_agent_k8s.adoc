...
* The NetApp Kubernetes Monitoring Operator, along with all its dependencies (telegraf, kube-state-metrics, fluentbit, etc.) is not supported on nodes that are running with Arm64 architecture.
