...
[inputs.prometheus] Error in plugin: error making HTTP request to /http://kube-state-metrics.netapp-monitoring.svc.cluster.local:8080/metrics: Get /http://kube-state-metrics.<namespace>.svc.cluster.local:8080/metrics: dial tcp: lookup kube-state-metrics.<namespace>.svc.cluster.local: no such host
