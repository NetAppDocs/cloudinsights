...
//The current Telegraf version for Cloud Insights is *1.21.4*.
...
Download all open source dependencies to your private docker registry. The following open source images need to be downloaded:
 ...
 gcr.io/kubebuilder/kube-rbac-proxy:<latest>
 k8s.gcr.io/kube-state-metrics/kube-state-metrics:<latest>

If fluent-bit is enabled, also download:

 docker.io/fluent-bit:<latest>
 docker.io/kubernetes-event-exporter:<latest>
