...
* If you are behind a proxy during installation, or when operating the Kubernetes cluster to be monitored, follow the instructions in the <<configuring-proxy-support,Configuring Proxy Support>> section. 
