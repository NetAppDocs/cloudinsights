...
Install the NetApp Kubernetes Monitoring Operator. See <<installing-the-netapp-kubernetes-monitoring-operator, instructions>> below when you are ready to install, after reading all of these these instructions.
