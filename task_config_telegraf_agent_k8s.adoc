...
summary: The NetApp Kubernetes Monitoring Operator collects Kubernetes data for use in Cloud Insights.  
---
...
IMPORTANT: Read the link:pre-requisites_for_k8s_operator.html[*Before Installing or Upgrading*] pre-requisites documentation before installing or upgrading the NetApp Kubernetes Monitoring Operator.
