...
* Control polling
* Edit data collector credentials  
...
. Click the three dot menu to the right and select Edit. 
. In the Data Collector configuration dialog, click *Advanced Confighuration*.
. Change the collection poll intervals.
...
Using the clone facility, you can quickly add a data collector that has the same credentials 
and attributes as another data collector. Cloning allows you to easily configure multiple 
