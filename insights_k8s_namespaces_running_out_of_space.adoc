...
Click on a workload to open a detail page for the Insight.  On this page you will see a graph showing the workload space trends as well as a table showing the following:
...
On the Insight page, click the *+Show Recommendations* to view possible solutions. The easiest option when running out of space is always to add more space, and Cloud Insights shows you the optimal space to add to increase time-to-full to a target 60-day prediction. Other recommendations are also shown.
