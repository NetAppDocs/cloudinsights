...
. In the Cloud Insights Reporting Portal, Go to *Menu > Content > My Content or Team Content*. Mouse over the report you want to customize and open the "three dots" menu.
