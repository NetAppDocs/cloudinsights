...
The link: https://docs.netapp.com/sgws-112/index.jsp[StorageGRID] firmware versions have corresponding API versions; 3.0 API newer versions support single sign on (SSO) login.
