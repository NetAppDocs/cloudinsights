...
The new dashboard opens in Edit mode. Give the dashboard a unique, meaningful name and click *Save*. To customize your dashboard, click *Edit* to return to Edit mode.

In Edit mode you can rename your dashboard at any time if you choose.
