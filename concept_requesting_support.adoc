...
image:Support_with_Chat.png[Support page]
...
* *Chat* - You wll be connected with NetApp support personnel for assistance (weekdays only). Click the bubble in the lower-right of the *Help > Support* page. Chat is also always available in the *Help > Live Chat* menu option in the upper right of any Cloud Insights screen.
