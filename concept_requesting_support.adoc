...
img:SupportPage_SN_Section.png[SN_Screen]

. Complete the Existing Customer Registration form and click *Submit*.

img:ExistingCustomerRegExample1.png[existing customer form]
...
img[NewCustomerRegExample.png[new customer form]
...
. his is a onetime registration for the AWS subscription and NetApp serial number. Any new Cloud Insights subscription and serial number requires registration as well.
...
img:Support_View_SN.png[View Support SN]
