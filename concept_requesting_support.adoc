...
* *Chat* - You wll be connected with NetApp support personnel for assistance (weekdays only). Click the bubble in the lower-right of the *Help > Support* page. Chat is also always available from the *Help* menu in the upper right of any Cloud Insights screen.
