...
. Select “Already registered as NetApp customer” and select _Cloud Insights_ as the Product Line. Select your Billing Provider (NetApp or AWS) and provide your Serial Number and your NetApp Subscription ID or AWS Customer ID by referring to the “Help > Support” menu within the Cloud Insights user interface:
+
...
. Select _Cloud Insights_ as the Product Line. Select your Billing Provider (NetApp or AWS) and provide your Serial Number and your NetApp Subscription ID or AWS Customer ID by referring to the “Help > Support” menu within the Cloud Insights user interface:
+
//image:SupportPage_SN_Section.png[SN_Screen]
image:SupportPage_SN_Section-NA.png[SN_Screen]
