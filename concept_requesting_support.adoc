...
image:SupportPageLayout.png[Support page]
...
NetApp provides support for Cloud Insights in a variety of ways. Extensive free self-support options are available 24x7, such as knowledgebase (KB) articles. For users who are subscribed to any of the Cloud Insights Editions (Basic*, Premium), technical support is available via phone or web ticketing. A NetApp Support Site (NSS) SSO account is required for web ticket along with case management.
