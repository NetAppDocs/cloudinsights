...
|===
|*Problem:* | *Try this:* 
|AU status displays "Certificate Expired” or “Certificate Revoked”. AU status is displayed on the *Admin > Data Collectors* page in the *Acquisition Units* tab.
|Click on the menu and select *Restore Connection*. Follow the instructions to restore your Acquisition Unit:
