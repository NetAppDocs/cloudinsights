...
|===
|*Problem:* | *Try this:* 
|Installation fails on SELinux|When the AU is installed on SELinux, SELinux should be either disabled or set to permissive mode. Once the installation is complete, enforcing mode can be enabled.   
