...
•	From the Cloud Insights Acquisition Unit:
  o	Open a CMD.
  o	Change the directory to the configured installation directory
  o	Try to make a connection with the CLARiiON device by typing “navicli -h {ip} getagent” (please replace the {ip} with real IP
