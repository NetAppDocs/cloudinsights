...
Cloud Insights is now available in a number of Editions to fit your budget and business needs. Enjoy 7 days of data retention and access to NetApp data collectors with the free Basic Edition, or get increased data retention, access to all supported data collectors, expert technical support and more with Standard or Premium Editions.  For more information on the features available, see NetApp's link:https://cloud.netapp.com/cloud-insights[Cloud Insights] site.
