...
[lead]
NetApp is continually improving and enhancing its products and services. Here are some of the latest features and functionalities available in the commercial Esditions of Cloud Insights.  

NOTE: Some of these features may not be available in Cloud Insights Federal Edition, or may be available with reduced functionality. Wherever possible, these differences are noted in this documentation.
