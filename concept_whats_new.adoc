...
*link:concept_dashboard_features.html#auto-refresh-and-tv-mode[TV Mode]* gives you an uncluttered, *Auto-Refreshing* display for constant, near-real-time viewing of any dashboard or landing page. Data is automatically refreshed according to the dashboard time range selected.
