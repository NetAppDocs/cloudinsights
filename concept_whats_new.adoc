...
The 2nd poll occurs immediately after completion of the inventory poll. The 3rd poll happens 15 seconds after completion of the 2nd poll. Polling then proceeds according to the configured inventory and performance intervals.
