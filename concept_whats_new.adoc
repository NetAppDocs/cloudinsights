...
Beginning in June, 2023, Cloud Insights will give you a breakdown of Managed Unit usage based on Feature Set. Now you can quickly view and monitor managed unit (MU) usage for your Observibility features as well as MU usage tied to Kubernetes. And coming soon, Workload Security MU usage!
