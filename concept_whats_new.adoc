...
* Export user activity report to CSV: Generate user activity audit reports required for compliance, using forensic filtering to filter data by any activity attribute such as time, user, volume, path, file type, activity type, etc.

//* Generate user activity audit reports required for compliance: use forensic filtering to filter data by any activity attribute such as time, user, volume, path, file type, activity type, etc. You can then export that user activity report to a .CSV file. 
