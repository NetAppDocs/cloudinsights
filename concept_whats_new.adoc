...
In Dashboards, Queries, and on the Audit page, the data for the "Owner" field was previously an ID string, instead of an owner name. The "Owner" field now shows a simpler and more readable owner name.
