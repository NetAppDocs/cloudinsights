...
Cloud Insights' powerful APIs are more accessible than ever, with Alerts APIs now available in Standard Edition.  
...
To enable benefits of multiple thresholds, webhook and email alert delivery, and more, Cloud Insights will be converting Standard and Premium Edition customers from *Performance Policies* to *Monitors* during the months of July and August, 2021. Learn more about link:https://docs.netapp.com/us-en/cloudinsights/task_create_monitor.html[Alerts ans Monitors], and stay tuned for this exciting change.
