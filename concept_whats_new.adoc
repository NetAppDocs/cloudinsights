...
==== Simplified Data Collector Configuration

* Data collector “Advanced Configuration” dialogs have been simplified and made more consistent across different types. 
