...
After you configure data collectors, devices in your environment including switches, storage arrays, and your virtual infrastructure of hypervisors and VMs are identified, you may still have unidentified devices. For these remaining unknown devices, Cloud Insights provides Automatic Device resolution.
