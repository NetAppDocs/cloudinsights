...
* Whitelisting *Allowed File Types*: If a ransomware attack is detected for a known file extension, that file extension can be whitelisted to prevent unnecessary alerting. - link:/ws_allowed_file_types.html[Learn More]
