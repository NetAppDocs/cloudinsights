...
==== Cloud Secure Alert Actions

Alert Actions allow Administrators to trigger manual snapshots. Snapshots can also be associated with policies which can get triggered on alerts.

image:AlertActionsExample.png[Alert Action Screen]
