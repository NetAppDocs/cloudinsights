...
Widgets are automatically named based on the first widget query. The name is created from the metric name (or object name, for tables) and "Group by" attributes (metric and aggregation method). 
