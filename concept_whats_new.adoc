...
* Cloud Insights supports link:task_dc_amazon_ec2.html#collecting_from_child_accounts[collection from child accounts] for AWS within a single AWS data collector.  
