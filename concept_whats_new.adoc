...
Managing and inviting users is a snap with APIs; you can invite users and assign roles based on the Cloud Insights feature sets you like: Monitor and Optimize, Cloud Secure, or Reporting.
...
==== Dashboard widget editor improvements

Creating or modifying a dashboard widget now gives you a full screen to work in and provides a cleaner, easier-to-use layout. In addition to putting the chart at the top of the screen (so it's always visible as you add or modify your query/queries), the editor separates filters for Metrics and Attributes, provides easier time range choosing, adds interpolation methods, and more. 

image:DashboardWidgetEditorScreen.png[Widget Editor Improved Layout]

==== New Count aggregation for Bar, Column, and Pie Charts

When grouping data in bar chart, column chart, and pie chart widgets, you can now choose _Count_ as an aggregation method, to quickly and easily show the number of relevant objects for the selected metric.
...
|Internal Volume and Volume Capacity Time-to-Full forcasting	
|Cloud Insights is able to prognose the number of days until capacity runs out for each Internal Volume and Volume monitored. This insight can help to significantly reduce the risk of an outage. 
