...
In addition to API categories for managing Assets and Data Collection, Cloud Insights has added a *Data Ingestion* category, giving you greater control over custom data and agents.
