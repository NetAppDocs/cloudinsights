...
=== Workload Security: Pause Automatic Agent Update

New Workload Security APIs give you more flexibility over your agents, by allowing you to pause automatic agent updates for up to 30 days. 

To pause or resume automatic agent updates, use the new _cloudsecure_config.agents_ APIs:
