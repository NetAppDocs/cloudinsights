...
* Advanced Data collection will be enabled for new ONTAP data collectors. To enable Advanced Data collection for current ONTAP data collectors, edit the data collector and expand the _Advanced Configuration_ section.
