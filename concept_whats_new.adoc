...
Many commercial applications support webhooks as a standard input interface. Cloud Insights supports many of these delivery channels, providing default templates for Slack, PagerDuty, Discord, and Teams, in addition to providing customizable generic webhooks to support many other applications.
