...
//By analyzing the historical behavior of the environment and establishing short- and long-term predictions, Data Infrastructure Insights generates detailed recommendations for host decommissioning as well as recommendations for reclamation of powered-off and idle VMs. These recommendations help you ensure performance stability, free up unused capacity, and reduce memory and CPU allocation, helping you manage infrastructure and licensing costs. 
