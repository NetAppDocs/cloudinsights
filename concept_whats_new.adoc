...
Storage Virtual Machines (SVMs) are available as assets in Cloud Insights. SVMs are displayed and used in search, queries, and filters, and can be used in dashboard widgets as well as associated with annotations.
