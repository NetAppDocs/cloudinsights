...
=== Am I registered for Support?

Your support Cloud Insights Support registration state is just a tap away. Select Help > Support to see your current _Support Level:_.
