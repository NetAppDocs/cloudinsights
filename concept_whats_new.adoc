...
==== Getting Started Checklist and Video Tutorials

A checklist of link:concept_getting_started_checklist.html[video tutorials] is available for a number of common Cloud Insights features and concepts. Tutorials are available for Dashboards, Queries, Policies, and more, and each tutorial can be viewed multiples times until dismissed. The checklist keeps track of which tutorials you have viewed. 
