...
The link:concept_audit.html[Audit page] provides a cleaner interface, includes the ability to filter for null/empty fields, and allows you to export up to 10,000 audit events to .CSV file.
