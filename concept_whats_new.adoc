...
Cloud Insights now allows searching for objects having null/none values through the use of filters. You can perform this filtering for both text-based and numeric objects in the following places:
