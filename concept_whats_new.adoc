...
Starting this month, "Monitor and Optimize" has been renamed *Observability*. Look here for features like Dashboards, Queries, Alerts, and Reporting. In addition, look for Cloud Secure under the new *Security* menu. Note that only the menus have changed; feature functionality remains the same.

image:New_CI_Menu_2022.png[New CI Menu]

Looking for the *Help* menu?  Here it is:
...
link:concept_ontap_essentials.html[*ONTAP Essentials*] is a set of dashboards and workflows that provide detailed views into your ONTAP inventories, workloads, and data protection, including days-to-full predictions for storage capacity and performance. You can even see if any controllers are running at high temperature. ONTAP Essentialsis your ideal place for all of your ONTAP insights! 
...
=== Reaady to Learn More?

Check out the *Learning Center* section of the Help > Support page for links to NetApp University course offerings!
