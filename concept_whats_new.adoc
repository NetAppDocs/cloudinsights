...
New Workload Security APIs are available to manage Data Collectors (add/update/delete) and Agents. Navigate to *Admin > API Access > API Documentation* and select the _Workload Security_ API type to learn more.
