...
The following capacity counters are available for use in Cloud Insights dashboards and REST API. Previously these counters were only available for the Data Warehouse / Reporting. 
