...
=== How's my Acquisition Unit?

Cloud Insights provides heartbeat monitors for your Acquisition Units, so you can be alerted to acquisition issues quickly. Additionally, two new monitors have been added to alert you to data collector failures. 
