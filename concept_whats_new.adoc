...
Cloud Insights Premium Edition comes with a link:concept_about_api.html[powerful API] that can be used to integrate Cloud Insights with other applications, such as CMDB’s or other ticketing systems. 
