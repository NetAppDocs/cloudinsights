...
link:concept_activeiq.html[Active IQ Risks] are now available as objects that can be queried as well as used in dashboard widgets.  

Queries for Active IQ Risks contain a link to the ActiveIQ page and allow you to include _Mitigation Category_, _Severity_, _UI Category_, and _Storage_ attributes.  
