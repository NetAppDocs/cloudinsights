...
=== Modify Multiple Monitor Notifications

New Bulk Actions available for Monitors allows you to edit notification settings, or remove notifications altogether, for multiple monitors at once. 
