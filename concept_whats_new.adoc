...
Cloud Insights provides visibility into the back-end storage for your Kubernetes environments, giving you insight to your Kubernetes Pods and Persistent Volumes (PVs). On a Volume or Internal Volume landing page, two new tables are displayed, for Kubernetes PVs and Pods.
