...
Auto-Refresh occurs for every widget on a dashboard at the set interval, regardless of whether that widget is configured to override dashboard time. Auto-Refresh can be paused and resumed at any time. 
