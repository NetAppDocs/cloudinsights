...
Video tutorials are available for a number of common Cloud Insights features and concepts. Videos are available for Dashboards, Queries, Policies, and more, and each video can be viewed multiples times until dismissed. The Checklist keeps track of which tutorials you have viewed. 
