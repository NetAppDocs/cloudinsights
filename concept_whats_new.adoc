...
Cloud Insights introduces link:concept_dashboard_features.html#dark-theme[Dark Theme] support, which displays most screens using a dark background with light text instead of a light background with dark text. 
