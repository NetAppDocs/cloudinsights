...
Cloud Secure now detects potential attacks such as ransomware, and displays a separate page for each specific attack with time of attack, associated user and file activity, and additional information to assist with tracking down possible security breaches.  

image:TBD[Ransomware Detail Page Example]
