...
The Cloud Insights left-side navigation menu has a new look! But don't worry, all of the Cloud Insights features are still here.  

image:NewLeftNavMenu.png[Updated Left Navigation Menu]

The following items are now in these menus:
