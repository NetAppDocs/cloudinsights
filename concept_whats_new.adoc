...
With Cloud Insights Premium Edition's powerful API, you can now link:#task_annotation_import.html[import annotations] and assign them to objects using a .CSV file. You can also import applications in the same way.
