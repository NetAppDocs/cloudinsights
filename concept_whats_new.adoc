...
Starting this month, "Monitor and Optimize" has been renamed "Observability". Look here for features like Dashboards, Queries, Alerts, and Reporting. 

image:New_CI_Menu_2022.png[New CI Menu]

=== Note sure where to start? Look at ONTAP Essentials!

link:concept_ontap_essentials.html[*ONTAP Essentials*] is a set of dashboards and workflows that provide detailed overviews of your ONTAP inventories, workloads, and data protection, including days-to-full predictions for storage capacity and performance. You can even see if any controllers are running at high temperature. ONTAP Essentialsis your ideal place for all of your ONTAP insights! 
