...
=== Expressions in Table Widgets

Dashboard Table Widgets allow you to add columns for custom expressions that you define. Up to 5 expression columns can be added, each having up to 5 terms. You choose how you calculate and name your expressions.

image:ExpressionExampleScreen.png[table widget edit screen showing an expression with a = iops total and b = iops read, with a custom column name, and showing that column in the table itself]
