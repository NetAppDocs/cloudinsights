...
You can choose to display Cloud Insights using a link:concept_dashboard_features.html#dark-theme[Dark Theme], which displays most screens using a dark background with light text instead of a light background with dark text.
