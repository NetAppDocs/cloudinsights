...
Starting April 2, Cloud Insights supports multiple subscriptions for a customer in a single Cloud Insights instance. Managed Unit (MU) from multiple accounts are aggregated as long as they share the subscription serial number is the same. 
