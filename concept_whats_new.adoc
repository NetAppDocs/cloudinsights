...
* Multiple Grouping: When working with integration data (Kubernetes, etc.) in certain widgets, for example line charts, you may choose to group the data by multiple criteria. You can group by as many criteria as you like.
