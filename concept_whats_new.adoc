...
Display your ONTAP storage shelf and node power consumption metrics in queries and dashboards, using the _netapp_ontap.storage_shelf_ and _netapp_ontap.system_node_ metrics.
