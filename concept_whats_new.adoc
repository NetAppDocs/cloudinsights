...
Cloud Insights can now be hosted in different regions across the globe, which facilitates performance and security for customers based outside the United States. Cloud Insights/Cloud Secure stores information according to the region in which your environment is created:
