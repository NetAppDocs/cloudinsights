...
Cloud Secure automatically deletes snapshots based on the Snapshot Purge Settings. 

image:CloudSecure_AutomatedResponsePolicies_WithSnapshotPurge.png[Purge Settings]
