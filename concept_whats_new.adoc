...
Cloud Cost provides a detailed link:http://docs.netapp.com/us-en/cloudinsights/task_getting_started_with_cloud_cost.html[cost analysis] of past, present, and estimated spending, providing visibility into cloud usage in your environment. The Cloud Cost dashboard delivers a clear view of your organization’s cloud expenses and a drill down into individual workloads, accounts, and services.
...
By supporting a generic, customizable webhook channel, Cloud Insights supports notifications using webhooks to many different applications, such as PagerDuty, Slack, and Jira.
...
[.thumb]
image:Webhook_Example_Slack.png[Example Webhook for Slack]

NOTE: Webhooks is considered a _Preview_ feature and is therefore subject to change.
////
