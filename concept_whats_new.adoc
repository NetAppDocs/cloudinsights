...
=== Set Grouping in Log Monitors

When creating or editing a Log Monitor, you can now set "Group By" attributes to allow for more focused alerting.  Set the "Group By" attributes in your monitor definitions, below the "filter" settings:
