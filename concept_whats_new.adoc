...
Widgets are automatically named based on the graph query. 
The name is based on the first widget query and it includes the metric name or object name (for tables) and "Group by" attributes. 
