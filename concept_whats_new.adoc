...
The dashboard gallery includes a new dashboard for ONTAP Power and Temperature as well as four dashboards for StorageGRID. If your environment is collecting ONTAP power metrics and/or StorageGRID data, import these dashboards on the Dashboards page by selecting *+From Gallery*. 



=== View your API usage

API Metering is now available on the *Admin > Subscription* page. Check out the _API Metering_ tab to explore API usage in your Cloud Insights environment.
