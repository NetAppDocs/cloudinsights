...
=== VM Optimization Feature

Save VM licensing costs by decommissioning hosts in underutilized clusters and reclaiming unused VMs. By analyzing the historical behavior of the environment and establishing short- and long-term predictions, Data Infrastructure Insights generates detailed recommendations for host decommissioning. These recommendations ensure performance stability while reducing infrastructure and licensing costs. 

Additionally, VM Optimization provides reclamation recommendations for powered-off and idle VMs, frees up unused capacity, and reduces memory and CPU allocation.
