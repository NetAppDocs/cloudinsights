...
=== Workload Secure REST cloudsecure_forensics.activities.v1 API is deprecated. This API returns information on activities associated with entities in the Storage Workload Security environment. 

cloudsecure_forensics.activities.*v2* is the new API.  
...
For more details see the Swagger documentation for “Admin->API Accessà API DocumentationàWorkload Security”. 
