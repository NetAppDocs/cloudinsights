...
The link:kubernetes_landing_page.html[Kubernetes Explorer] is a powerful tool to explore, inform, and/or troubleshoot your Kubernetes environment. Information that can be explored using the Kubernetes Explorer includes drill-down details of usage and health for the Clusters, Nodes, and Pods in your Kubernetes environment.
