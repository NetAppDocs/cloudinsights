...
==== Duplicating
You can now clone (duplicate) the Change Log, Kubernetes Log, and Data Collector Log monitors. This creates a new custom log monitor that you can modify to your specifc definitions.

image:Log_Monitor_Duplicate.png[Duplicating a Log Monitor]


=== 11 New Monitors for SMBC
