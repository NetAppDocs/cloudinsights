...
Cloud Insights now filters for Null values on the Query page, in Dashboard Widgets, and on the Audit page. To filter for Null values, simply select the _None_ option in the appropriate filter drop-down. 
