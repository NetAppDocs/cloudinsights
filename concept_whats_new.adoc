...
Cloud Insights now has an updated object iconography, reducing overall variance of  icons used on the various Cloud Insights pages as well as grouping similar objects together (for example, Volume-related objects). Previous 'letter-based' icons are replaced with image-based graphics, making Cloud Insights screens more user-friendly and accessible.
