...
By supporting a generic, customizable webhook channel, Cloud Insights supports notifications using webhooks to many different applications, such as Slack, Jira, and Discord.
...
[.thumb]
image:Webhook_Example_Discord.png[Example Webhook for Discord]
