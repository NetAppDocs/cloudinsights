...
==== Automatic Suggestions, Wildcards, and Expressions in Filters
...
Read more about link:link:task_create_query.html#more-on-filtering[filtering options] in queries and widgets.
