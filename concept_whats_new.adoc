...
You can also now pin dashboards within your groups, so favorite dashboards always appear at the top of the list. Pinning a dashboard in one group also pins it to the top of any other group containing that dashboard. Dashboards you pin in your groups are not pinned in another user's groups.
