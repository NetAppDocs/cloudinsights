...
=== ONTAP Essentials filter on Vendor for VMs

ONTAP Essentials filtering and sorting can now be performed on _storageResources.vendor_ for Virtual Machine objects.
