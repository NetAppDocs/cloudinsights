...
Display and monitor your ONTAP storage shelf and node power consumption, temperature, and fan speed, using the_netapp_ontap.storage_shelf_, _netapp_ontap.system_node_ and _netapp_ontap.cluster_ (power consumption only) metrics.

image:ONTAP_Power_Metrics_1.png[storage shelf power metrics]
//image:ONTAP_Power_Metrics_2.png[system node power metrics]
