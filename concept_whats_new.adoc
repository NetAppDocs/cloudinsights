...
* Cloud Insights supports link:task_dc_amazon_ec2.html#collecting_from_child_accounts[collection from AWS child accounts] within a single data collector. Your AWS environment must be configured to allow Cloud Insights to collect from child accounts.
