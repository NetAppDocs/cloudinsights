...
* Multiple grouping: For Integration data (Kubernetes, ONTAP Advanced Metrics, Docker, etc.), you can choose multiple attributes/metrics for grouping. Data is displayed according to the grouping attributes/you choose. 
+
Grouping for Infrastructure data (storage, EC2, VM, ports, etc.) is by a single attribute as before.
+
