...
Cloud Insights provides a dashboard to forecast the number of days until capacity runs out for each Storage, Storage Pool, Internal Volume, and Volume monitored. These values can help to significantly reduce the risk of an outage. 
