...
Cloud insights includes a number of link:task_system_monitors.html[system-defined monitors] for both metrics and logs. 

image:SystemMonitorGroups.png[System Monitor Groups]

Additionally, the Queries feature includes a powerful link:concept_log_explorer.html[Log Explorer], allowing you to easily investigate and troubleshoot log entries. 
