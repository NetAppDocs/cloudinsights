...
Cloud Insights now filters for Null values on the Query page and in Dashboard Widgets. To filter for Null values, simply select the _None_ option when it appears in the appropriate filter drop-down. 
