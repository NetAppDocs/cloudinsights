...
* "Seasonality" of behaviors: your weekend environment data may follow different patterns from your weekday, or your morning from your afternoon. Workload Security algorithms take this seasonality into acount.
