...
Starting today, signing up for a new Trial of Cloud Insights allows you to explore Cloud Secure features such as Ransomware Protection and User Blocking. If you haven't signed up for your Trial, do it today!


=== Kubernetes Workloads have their own landing page

Workloads are the backbone of your Kubernetes environment, so Cloud Insights now provides landing pages for those workloads. From here, you can view, explore, and troubleshoot issues that affect your Kubernetes workloads.
