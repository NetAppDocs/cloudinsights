...
link:concept_activeiq.html[Active IQ] Risks are now available as Objects that can be queried and displayed in dashboards.  

Queries for Active IQ Risks now contain a link to the ActiveIQ page and allow you to include Mitigation category, Severity, UI category, and Storage attributes.  
