...
Cloud insights includes a number of link:task_system_monitors.html[system-defined monitors] for both metrics and logs. System-defined monitors are paused by default, giving you control over which monitors are most important to you. Monitors are available for:

*	ONTAP metrics
*	Kubernetes metrics
*	ONTAP logs
*	Kubernetes logs 
* Astra Data Store metrics
