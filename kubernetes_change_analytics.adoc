...
* In multi-tenant environments, outages may happen because of mis-configured changes. In very dynamic environments, Cloud Insights may not be able to properly track all changes.
