...
* In multi-tenant environments, outages may happen because of mis-configured changes. In very dynamic environments, Cloud Insights Change Analytics may not be able to properly track all changes.
* Change Analytics provides a single pane to view and correlate the health of workloads and configuration changes. This may help in troubleshooting dynamic environments.
