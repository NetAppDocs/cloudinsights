...
* For accurate audit and data reporting, it is strongly recommended to synchronize the time on the acquisition unit server using *Network Time Protocol (NTP)* or *Simple Network Time Protocol (SNTP)*.
