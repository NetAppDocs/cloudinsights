...
* Acquisition unit login endpoint (always \https://aulogin.<Cloud Insights Domain>)
* Cloud Insights site name (also called the tenant) (\https://<Tenant Name>.<Cloud Insights Domain>)
