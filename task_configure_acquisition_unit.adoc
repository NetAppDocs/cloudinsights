...
. Verify that the server is running a supported version of Linux. Click _Versions Supported (i)_ for a list of supported versions.
...
. Verify that the server or VM hosting the Acquisition Unit meets the recommended system requirements. 
. Verify that the server is running a supported version of Windows. Click _Versions Supported (i)_ for a list of supported versions.
