...
. Go to *Admin > Data Collectors* and select the *Acquisition Units* tab.
...
. On the Acquisition Unit server/VM, run the following command: sudo cloudinsights-uninstall.sh
. For help with uninstall, run: sudo cloudinsights-uninstall.sh --help
