...
* Acquisition unit login endpoint: [.userinput]#aulogin._<Cloud Insights Domain>_#
* Cloud Insights site name (also called the tenant): [.userinput]#_<Tenant Name>.<Cloud Insights Domain>_#
