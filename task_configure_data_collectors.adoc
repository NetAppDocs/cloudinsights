...
NOTE: Not all devices require passwords. Some data collectors don't allow for entering any credentials, while others (for example, Amazon ECS or Google Compute) have other encrypted fields, but not “Password” apecifically.
