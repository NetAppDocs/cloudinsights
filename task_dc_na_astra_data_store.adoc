...
This data collector acquires inventory and performance data for a single Astra Data Store cluster. In addition to the data collector, the Monitoring Operator will collect advanced metrics as well as configure _Fluent Bit_ to collect logs.
