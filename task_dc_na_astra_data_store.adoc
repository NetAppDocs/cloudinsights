...
TIP: These installation instructions and additional information can also be found in the link:https://https://docs.netapp.com/us-en/astra-data-store/monitor-with-cloud-insights.html[Astra Data Store documentation].
