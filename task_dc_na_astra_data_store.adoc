...
TIP: These instructions and additional information can also be found in the link:https://review.docs.netapp.com/us-en/astra-data-store_ads-PI4-review/use/monitor-with-cloud-insights.html#perform-cloud-insight-connection-prerequisites[Astra Data Store documentation].
...
* The _ubectl-astrads_  kubectl plugin must be installed. If it is not installed, please install the _kubectl-astrads_ binary following the Astra Data Store installation instructions.
