...
TIP: These installation instructions and additional information can also be found in the link:https://docs.netapp.com/us-en/astra-data-store/use/monitor-with-cloud-insights.html[Astra Data Store documentation].
