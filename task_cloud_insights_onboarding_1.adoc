...
If this is your first time logging in to Cloud Insights, under the Cloud Insights offering, click on *Register for Free trial*. You will be prompted to answer a few questions. Cloud Insights will then create your company's environment.

You will receive an email when your site creation is complete. Once the creation of your environment is complete, you can use your Cloud Central credentials to log in and start your free, 14-day trial of Cloud Insights. During this trial you can explore all the features that Cloud Insights Standard Edition has to offer. 
...
You can also open a browser directly to your Cloud Insights environment URL:
 ...
 https://<your-environment-name>.cloudinsights.netapp.com/
