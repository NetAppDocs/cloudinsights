...
[.lead]
Before you can start working with Cloud Insights, you must sign up on the link[*NetApp Cloud Central*] portal. If you already have a NetApp Cloud Central login, you can start a free trial of Cloud Insights with a few quick steps.
...
If this is your first time logging in to Cloud Insights, under the Cloud Insights offering, click on *Register*. You will be prompted to answer a few questions. Cloud Insights will then create your company's site based on your responses. Cloud Insights will assign a site ID and create a unique site name based on that ID and your company name.

You will receive an email when your site creation is complete. Once the creation of your tenant is complete, you can use your Cloud Central credentials to log in and start your free, 14-day trial of Cloud Insights. During this trial you can explore all the features that Cloud Insights Standard Edition has to offer. 
