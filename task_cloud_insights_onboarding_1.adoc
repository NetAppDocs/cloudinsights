...
You will be prompted to answer a few questions and request a name for your tenant. Cloud Insights will then create your company's tenant based on your responses. You will receive an email when your tenant creation is complete.
...
Once the creation of your tenant is complete, you can use your Cloud Central credentials to log in to it.
