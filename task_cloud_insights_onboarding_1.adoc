...
NOTE: Logging out of Cloud Insights logs you out of BlueXP. You will also be logged out of other NetApp Cloud services that use the link:https://docs.netapp.com/us-en/bluexp-setup-admin/task-logging-in.html[BlueXP sign-in].
