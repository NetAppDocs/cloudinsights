...
To add monitors to the group, select a group and do one of the following:
...
* Click on the monitor name to open the edit view, and select a group in the _Associate to a monitor group_ section.
+
...
To pause or resume all monitors in a group at once, select the menu for the group and click _Pause_ or _Resume. 
