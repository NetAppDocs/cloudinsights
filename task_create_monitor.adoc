...
You can add an optional description as well as additional insights and/or corrective actions by filling in the *Additional Alert Details* section. The description can be up to 1024 characters and will be sent with the alert. The insights/corrective action field can by up to 67,000 characters and will be displayed in the summary section of the alert landing page.
