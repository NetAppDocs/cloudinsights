...
Remove monitors by clicking on a group and selecting _Remove From Group_ from the menu. You can not remove monitors from the _All monitors or _Custom monitors_ group. To Delete a monitor from these groups, you must delete the monitor itself.
