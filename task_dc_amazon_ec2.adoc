...
** The IAM Role for your Amazon EC2 cloud account, if using IAM Role Authentication. IAM Role only applies when your acquisition unit is installed on an AWS instance.
