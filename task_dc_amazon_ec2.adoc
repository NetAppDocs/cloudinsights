...
|Choose 'Exclude' or 'Include' to Apply to Filter VMs by Tags|You can choose VMs to filter in or out of polling
|Tag Keys and Values on which to Filter VMs|Keys for VMs to include or exclude from polling
