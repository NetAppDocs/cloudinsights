...
Cloud Secure can integrate with other tools as well.  For example, link:http://docs.netapp.com/us-en/cloudinsights/CloudInsights_CloudSecure_Splunk_integration_guide.pdf[see this guide] on integration with Splunk.
