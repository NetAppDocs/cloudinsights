...
|===
|Name|Description
|User Directory Name |Unique name for the user directory. For example _GlobalADCollector_
|Agent|Select a configured agent from the list
|Server|IP address or Fully-Qualified Domain Name (FQDN) of server hosting the active directory
