...
_The report data available to you is controlled by several things, including the following:

* Login access to the Reporting Portal, which is defined by roles.
* The setup of the Cloud Insights Data Warehouse, which stores the data for the reports._
