...
|workload-map||Configuration options for workload map 
...
spec:
  ...
  telegraf:
    ...
    # dsBlockIOEnabled: '{{ .Values.telegraf_installer.kubernetes.ds.shim_blk_io_processing }}'
    # # Collect NFS IO metrics.
    # dsNfsIOEnabled: '{{ .Values.telegraf_installer.kubernetes.ds.shim_nfs_io_processing }}'

    # # Collect Docker metrics.
    # dockerMetricCollectionEnabled: true

    # # Overrides for K8s platforms with nonstandard docker installations such as Cloud Foundry.
    # crioSockPath: '/var/run/crio/crio.sock'
    # dockerMountPoint: '/var/run/docker.sock'
    # dockerUnixSocket: 'unix:///run/docker.sock'
