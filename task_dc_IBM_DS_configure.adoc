...
The IBM DS (CLI) data collector supports DS6xxx and DS8xxx devices. DS3xxx, DS4xxx, and DS5xxx devices are supported by the NetApp E-Series data collector. You should refer to the Cloud Insights support matrix for supported models and firmware versions.
