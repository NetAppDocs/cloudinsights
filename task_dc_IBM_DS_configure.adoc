...
DS3xxx, DS4xxx, and DS5xxx devices are supported by the <task_dc_na_eseries>.html[NetApp E-Series data collector]. You should refer to the Cloud Insights support matrix for supported models and firmware versions.
