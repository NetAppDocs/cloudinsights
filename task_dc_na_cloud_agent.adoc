...
NOTE: Starting with ONTAP 9.9+, the data collection no longer requires a traditional acquisition unit. Data is instead collected using the cloud connection, eliminating the need to install an external acquisition unit. 
