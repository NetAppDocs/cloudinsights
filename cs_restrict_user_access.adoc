...
NOTE: When using the Amazon FSx data collector, user blocking for SMB cannot kill the current user session.  See <<troubleshooting, the Troubleshooting section>> for more information.
