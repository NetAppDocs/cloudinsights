...
NOTE: This page refers to third-party instructions, which could be subject to change. Refer to the link:https://discord.com/developers/docs/resources/webhook[Discord documentation] for the most up-to-date information. 
