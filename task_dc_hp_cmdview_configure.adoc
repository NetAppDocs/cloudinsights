---
sidebar: sidebar
permalink: task_dc_hp_cmdview_configure.html
keywords: data collector, Command View, HDS, HP 
summary: Configuring HP Command View Device Manager data collector.
---

= HP Command View Device Manager data collector
...
The Command View and Command View Lite data collector support the Command View Device Manager server. Cloud Insights communicates with the HiCommand Device Manager server using the standard High Command  API.

== Terminology 

Cloud Insights acquires the following inventory information from the HDS Command View data sources. For each asset type acquired by Cloud Insights, the most common terminology used for this asset is shown. When viewing or troubleshooting this data collector, keep the following terminology in mind:
...
* Validate access: 
** Log in to the Command View Device Manager software using peer user name and password.
** Verify access to the Command View Device Manager API: _telnet <HiCommand Device_Manager_server_ip> 2001_ 
...
|===
|Field|Description
|Command View Server |IP address or fully-qualified domain name of the Command View Device Manager server 
|User Name |User name for the Command View Device Manager server. 
|Password|Password used for the Command View Device Manager server. 
...
|===
|Field|Description
|Command View Server Port |Port used for the Command View Device Manager 
