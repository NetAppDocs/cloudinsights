...
**	NFS protocol version 4.1 and earlier 
...
* A paused Data Collector can not be deleted. 
* While paused, the fpolicy settings in ONTAP are disabled but are not deleted. On resume, the fpolicy settings in ONTAP are re-enabled.
