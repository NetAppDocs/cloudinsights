...
** Data ONTAP 9.2 and later versions. For best performance use Data ONTAP versions where link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/BURT/1372994[this issue] is fixed 
...
|After enabling Cloud Secure, ONTAP performance is impacted. Latency becomes sporadically high, while IOPs becoming sporadically low.
|Ensure that you are using an ONTAP build containing the fix for link:https://mysupport.netapp.com/site/bugs-online/product/ONTAP/BURT/1372994[this issue].
