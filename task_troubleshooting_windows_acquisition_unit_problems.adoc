...
|Network Requirements not met |Ensure that your Acquisition Unit server/VM can access your Data Infrastructure Insights environment (<environment-name>.c01.cloudinsights.netapp.com) through SSL connection over port 443 (opened bi-directional). Try the following commands:
