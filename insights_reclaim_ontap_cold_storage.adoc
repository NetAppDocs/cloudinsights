...
* Cold data less than 30 days old is not shown.
* Constituent volumes in a flexgroup are not included in cold data calculations (because tier policy cannot be set on the constituents).
