...
|After typing some letters containing a wildcard character like ‘*’ in the filters on the Forensics _All Activity_ or  _Entities_ pages, the pages load very slowly.
