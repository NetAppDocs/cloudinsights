...
* The *Original Path* used for rename events when the original file was renamed. By default , it is not visible in the table. You need to use column selector to add this column to the table.

* The *Volume* where the entities reside. By default , it is not visible in the table. You need to use column selector to add this column to the table
...
All activity table shows default columns. To add, remove, or change the columns, click the gear icon on the right of the table. It will list available columns for the table.

image:CloudSecure_ActivitySelection.png[Activity Selector, width=50%]
