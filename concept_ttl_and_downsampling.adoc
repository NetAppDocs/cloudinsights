...
[.lead]
Because Cloud Insights retains your data for up to 90 days, there is potential for tens of thousands of data points to be processed for charts and tables. Data may therefore be downsampled before being displayed. 
