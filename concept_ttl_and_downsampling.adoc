...
[.lead]
Cloud Insights time-to-live (TTL) for data is 90 days. Because Cloud Insights retains your data for 90 days, there is potential for tens of thousands of data points to be processed for charts and tables. Data may therefore be downsampled before being displayed. 
