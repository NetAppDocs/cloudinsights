...
A full list of features available in each Edition is available on the Cloud Insights link:https://bluexp.netapp.com/cloud-insights-pricing[Editions and Pricing] page.
