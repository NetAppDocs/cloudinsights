...
[.lead]
Cloud Insights retains your data for 90 days. Because that means the potential for tens of thousands of data points to be processed for charts and tables, data may be downsampled before being displayed. 
+
