...
* Functional Data
+
This is information about your Cloud Insights infrastructure, service configuration, and telemetry. This information remains within the region where the tenant resides.
//about how Cloud Insights is being used and may include things like number of users accessing Cloud Insights, number and nature of API calls being made, etc. Functional data allows NetApp to understand how customers are using its products.
...
* Functional data, which includes telemetry, environmant, and asset/object information, including counters and performance metrics
