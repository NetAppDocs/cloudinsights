...
In a time-series widget (line, spline, area, stacked area chart), you can hover over a legend to highlight the associated data in a chart. Conversely, hovering over a data point in the chart will highlight the associated legend.
