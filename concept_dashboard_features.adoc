...
. Choose a value for the "Warning" threshold. When the widget displays values above this level, it displays the gauge in orange. 

. Choose a value for the "Critical" threshold. Values above this level will cause the gauge to display in red.
