...
You can use exact match filters to find specific resources, for example hostname. If you want to find only the hostname 'marketing' but exclude 'marketingo1', 'marketing-boston', etc., simply enclose the name "marketing" in double quotes. 
