...
You can see many of these features in action in the link:https://docs.netapp.com/us-en/cloudinsights/task_dashboard_example_VM_performance.html[example dashboard] topics.

toc::[]

==	Widget Placement and Size
All dashboard widgets can be positioned and sized according to your needs for each particular dashboard. To move a widget, Select *Edit* mode. Click the upper part of the widget and drag to a new location. To resize a widget, drag the lower-right corner of the widget to the desired size.
...
To rename a dashboard, open the dashboard page and click *Edit*. In the title bar, type the new dashboard name. Click *Save*.

image:RenameDashboard.png[Rename Dashboard]
