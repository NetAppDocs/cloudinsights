...
In this example, the data is displayed in Whole Number format. You can choose another format in which to display the values. In this case, you can choose from Whole Number, thousand, million, billion, or trillion. The Y-Axis label and values change according to the format you choose, as shown below.
