...
keywords: dashboard, widget, custom, concepts, queries, variables, rollup, roll up, grouping, aggregate, aggregation, filter, axis, expressions
---
...
+
image:tbd.png[Grouping Example]

. Click *Save* to save the table to the dashboard. You can resize or mpove the widget as desired.
