...
image:Variables_Node_Example__Variable_Applied.png[Agent Nodes After Variable Filter]
...
* Filter all widgets by the specified attribute (foir example, *agent.node.agent_node_ip*)
