...
You can also set a variable to filter on all objects with a particular attribute regardless of object type, for example objects with an attribute of "name", by specifying _*.name_ in the variable field. You do not need to type the "*"; Cloud Insights will supply this as you type.
