...
Most widgets on a dashboard allow you to specify the Units in which to display values. In many cases, Cloud Insights can guess the best format for the data (for example, KB/s, Thousands, Dollars, etc.)
