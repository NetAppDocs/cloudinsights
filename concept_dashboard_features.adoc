...
* *Count*: displays a _count_ of objects that have reported data within the specified time frame (5 minute, 1 hour, or entire time window). // You can choose to include _all_ objects that have reported data, or only those objects whose data is reported as _Not Null_. 
