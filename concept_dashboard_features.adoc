...
But if you temporarily want to see only nodes on individual subnets in your environment, you can set the variable for a specific Agent Node IP. Here we are viewing only the nodes on the "123" subnet:
