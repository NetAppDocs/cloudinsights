...
Choose a value for the "Warning" level. When the widget displays values above this level, it displays the gauge in orange. 
...
image:SVW-Formatted.png[Single-Value Widget with Formatting, width=374]
