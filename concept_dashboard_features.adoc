...
image:DashboardGroupsExample.png[Dashboard Grouping]

Two groups ar shown by default:
...
To add dashboards to the group, click the _All Dashboards_ group to show all dashboards in your environment and do one of the following:
...
You can further manage your dashboards by pinning favorite ones to the top of your groups. To pin a dashboard, simply click the thumbtack button displayed when you hover over a dashboard in any list. 

Pinning a dashboard pins it to the top of the current group, as well as any other groups containing that dashboard. 

NOTE: Pinning a dashboard moves it to the top of your groups only. It does not pin it to the top of another user's groups.
