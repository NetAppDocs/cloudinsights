...
For storage systems using Data ONTAP software operating in 7-Mode, you should use the ONTAPI data collector, which uses the CLI to obtain capacity numbers. 
