...
For storage systems using Data ONTAP software operating in 7-Mode, you should use this data collector, which uses the CLI to obtain capacity numbers. 
...
* Access validation
+
Use telnet to access the FAS controller from the Authorization Unit,  using the user name and password.
