...
For csuser with _cluster_ credentials, execute the following commands from the ONTAP command line. Note that _csrole_ is custom role and _csuser_ is ontap custom user.
