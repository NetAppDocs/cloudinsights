...
|TCP|7|SVM data LIF IP Addresses|Outbound|Uni-directional between ONTAP and Workload Security. Agent pings the SVM Lifs.
|SSH | 22 | Cluster management |Outbound| Needed for CIFS/SMB user blocking.
|===
