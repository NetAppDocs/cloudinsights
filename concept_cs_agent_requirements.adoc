...
Note that if you add _<</task_add_collector_svm.html#permissions-when-adding-via-cluster-management-ip, csuser>>_, that user requires SSH access to the ONTAP management LIF.
