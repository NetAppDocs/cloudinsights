...
NOTE: The account where the collector is installed needs to have _delegate access administrator_ privileges.  See the link:https://docs.aws.amazon.com/accounts/latest/reference/using-orgs-delegated-admin.html[AWS Documentation] for more information. 
