...
Select the _View Details_ link for a cluster to open a "slideout" panel showing you the current settings for the cluster. Select from _Cluster, Storage VM,_ or _Anti-Ransomware_ Settings.
