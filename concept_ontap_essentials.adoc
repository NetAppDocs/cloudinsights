...
Note that a "days to full" number of "0" (zero) indicates that days to full is estimated at greater than 365 days. In other words, your systems aren't in danger of running out of space any time soon.
