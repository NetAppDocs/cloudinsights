...
NOTE: Beginning in November 2021, ONTAP Advanced Counter data collection will be enabled by default. This feature will be rolled out gradually; you will see the advanced data in your dashboards over time. To disable Advanced Data collection, edit the ONTAP data collector and un-check the 'Opt in for Advanced Counter Data Collection rollout' checkbox.
