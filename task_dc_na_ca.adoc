...
Learn how to install and configure the Config Advisor data collector, and how to use dashboards to get the most out of Config Advisor in Cloud Insights.

Video: video:Config_Advisor_Collector_Part1.mp4[Installing and Configuring the Config Advisor data collector]
Video: video:Config_Advisor_Collector_Part2.mp4[Using dashboards to view Config Advisor data]
