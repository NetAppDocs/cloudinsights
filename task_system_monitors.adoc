...
NOTE: Removing a monitor from a group does not delete the monitor from Data Infrastructure Insights. To completely remove a monitor, select the monitor and click _Delete_. This also removes it from any group to which it belonged and it is no longer available to any user.
...
Use the same menu to rename or delete a group. Deleting a group does not delete the monitors from Data Infrastructure Insights; they are still available in _All Monitors_. You cannot delete system-defined monitor groups.
