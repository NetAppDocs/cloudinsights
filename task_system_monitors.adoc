...
[.lead]
Beginning in October 2021, Cloud Insights will be including a number of system-defined monitors monitors for both metrics and logs. The Monitors interface will include a number of changes to accomodate these system monitors. These are described in this section.
