...
* You can display audit entries by choosing a particular time period (1 hour, 24 hours, 3 days, etc.), with Cloud Insights showing a maximum number of 1000 violations for the selected time period.
