...
+
Example: _User *Jane Smith* logged in from *10.1.256.22*, user agent *Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.121 Safari/537.36*, login method(s) *BlueXP Portal Login_* 
