...
* If you have non-admin users who will subsequently need to access the SecurityAdmin tool, they must have _cisys_ permissions (individual or group). The _cisys_ group is created if necessary during AU installation.
