...
image:SecurityAdmin_Encrypt_Key_1.png[Interactive Mode Encrypt Password, width=600]
...
image:SecurityAdmin_Encrypt_Key_Swagger_API.png[API for data collection, width=600]
