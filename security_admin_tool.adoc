...
image:SecurityAdmin_Encrypt_Key_1.png[Interactive Mode Encrypt Password, width=460]
...
image:SecurityAdmin_Encrypt_Key_Swagger_API.png[API for data collection, width=460]
...
image:SecurityAdmin_Encrypt_Key_API_Example.png[API Example, width=460]
