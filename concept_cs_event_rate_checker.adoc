...
An Agent can support a maximum of 50 data collectors.
...
A) Use this table as a general sizing guide. An agent can support up to a maximum of 50 data collectors:
