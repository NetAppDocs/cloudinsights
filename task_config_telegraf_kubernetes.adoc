...
Note that there are two different config maps that need updating: _telegraf-conf_ for the daemonset and _telegraf-conf-rs_ for the kube-state-metrics data.
