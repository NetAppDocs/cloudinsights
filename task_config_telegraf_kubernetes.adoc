...
For Kubernetes Installation instructions, including information on Kube-State-Metrics, please see the link:task_config_telegraf_agent.html#kubernetes[Agent Installation] page.
