...
* Root/sysadmin user account and password that exist on all servers hosting Ops Center components. HDS did not implemente REST API support for usage by LDAP/SSO users until Ops Center 10.8+
