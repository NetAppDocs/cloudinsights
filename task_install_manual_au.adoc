...
. Download the AU Installer using the _/au/installers/{platform}/{version}_ API:
.. Platform: *linux*
...
. Note: If you plan to administer AU using different custom users, ensure group permissions are set to read and write for both owner and group (_chmod 660 …_)

. Restart the AU. 

.. In Cloud Insights, navigate to *Admin > Data Collectors* and select the *Acquisition Units* tab. Choose _Restart_ from the “three dots” menu to the right of the AU.
