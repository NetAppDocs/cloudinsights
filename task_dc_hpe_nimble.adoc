...
summary: Configuring the HPE Alletra 6000 (formerly Nimble) data collector.
---
...
The HPE Alletra 6000 (previously Nimble) data collector supports inventory and performance data for HPE Alletra 6000 storage arrays. 
