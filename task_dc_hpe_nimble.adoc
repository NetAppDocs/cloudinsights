...
You must have the following in order to collect inventory and configuration data from the Nimble storage array:
...
You must have the following in order to collect performance data from the Nimble storage array:
