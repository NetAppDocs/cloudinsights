...
+
With a text-type annotation, you can also include a hyperlink. Hyperlinks must require of the following formats:
+
...
+
Values will show as hyperlinks on the query results page and in table widgets.
