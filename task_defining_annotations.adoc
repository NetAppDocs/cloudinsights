...
summary: You can customizing Cloud Insight to track data for your corporate requirements using  specialized notes, called annotations, and assign them to your assets. 
---
[.lead]
