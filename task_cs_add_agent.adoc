...
|Agent was initially connected via a proxy server and the proxy was set during Agent installetion. Now the proxy server has changed. How can the Agent’s proxy configuration be changed?
|You can edit the Agent.properties, add the proxy details and restart the Agent.
Follow the steps mentioned below. Let us know if you face any issues.
Add proxy details:
[root@scspa2671457001 conf]# pwd
/opt/netapp/cloudsecure/conf
[root@scspa2671457001 conf]# ls
agent.properties
[root@scspa2671457001 conf]# cat agent.properties
TOKEN=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzM4NCJ9..vrqNQEr3Fs-DrLuVaNk37rWdNvHPxW5avjuS5GdzMGDI0raJlcC5f0lBheXeDS6u
AGENT_ENVIRONMENT=prod
AGENT_INSTALLATION_DIR=/opt/netapp/cloudsecure/
AGENT_EXTERNAL_BASE_PATH=/opt/netapp/cloudsecure/agent
MIN_PORT=35000
MAX_PORT=55000
