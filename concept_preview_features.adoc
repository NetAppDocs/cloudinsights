...
|Cloud Insights is able to prognose the number of days until capacity runs out for the following objects:
...
These forecast values can help to significantly reduce the risk of an outage. Use the _timeToFull.total_ and _timeToFull.confidenceInterval_ counters in Queries, Monitors, or Dashboards.
