...
|Cloud Insights is able to prognose the number of days until capacity runs out for each Internal Volume and Volume monitored. This value can help to significantly reduce the risk of an outage. Use the timeToFul.total and timeToFull.confidenceInterval counters in Queries, Monitors, or Dashboards to 
