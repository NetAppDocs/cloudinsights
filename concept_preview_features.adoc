...
|Kubernetes Running Out of Space
|Cloud Insights helps you predict the time you have before a Kubernetes space becomes full.

|Internal Volume and Volume Capacity Time-to-Full forecasting	
|Cloud Insights is able to prognose the number of days until capacity runs out for each Internal Volume and Volume monitored. This value can help to significantly reduce the risk of an outage. Use the timeToFul.total and timeToFull.confidenceInterval counters in Queries, Monitors, or Dashboards to show space usage trends.
