...
The API Documentation is Swagger-based, which provides a brief description and usage information for the API, and allows you to try it out in your environment. Depending on your user role and/or Data Infrastructure Insights edition, the API types available to you may vary.
...
//* DATA WAREHOUSE type is available for environments with Data Infrastructure Insights Reporting, and is used to manage data used with Reporting
...
The Data Infrastructure Insights APIs can be generally separated into the following sections: 
////

////
admin::
Provides an entry point to the system for administrative operations in Data Infrastructure Insights. Allowed roles are Any, User, and  Administrator and includes the following:
