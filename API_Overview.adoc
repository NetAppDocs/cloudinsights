...
Additionally, your Cloud Insights feature set roles will determine which APIs you can access. User and Guest roles have fewer privileges than Administrator role. For example, if you have Administrator role in _Monitor and Optimize_, but User role in _Reporting_, you will see all API types except _Data Warehouse_.
