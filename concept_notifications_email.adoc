...
[.lead]
You can also configure an email list for subscription-related notifications. You can also configure a global email list of recipients for notification of performance policy threshold violations. 
