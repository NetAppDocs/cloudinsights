...
NOTE: You can override the global list for any policy when you link:task_create_performance_policies.html[configure the policy].
...
A notification email will be sent to these recipients when any of the following events occur:
