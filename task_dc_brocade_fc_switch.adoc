...
|Retrieve MPR Data|Select to acquire SAN routing data
...
|The issue may be caused when the Brocade switch takes too long to return with a prompt, after successful authentication, exceeding the default timeout of 20 seconds.
