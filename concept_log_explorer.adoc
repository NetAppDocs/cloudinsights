...
Note that when zooming the graph or scrolling the table, dashboard auto-refresh will pause and the time range will show the frozen time. To reseume refresh, click the _Resume_ button. image:ResumeButton.png[]
