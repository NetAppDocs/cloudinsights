...
4. The chart results have been Grouped By the _source_ field. The chart shows results each column grouped into colors. Hovering over a column in the chart will display some details about the specific entries.
+
