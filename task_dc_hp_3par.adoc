...
summary: Configuring the HPE Alletra 9000 / HPE Primera (formerly 3PAR) data collector. 
---

= HPE Alletra 9000 / HPE Primera Storage data collector
...
Cloud Insights uses the HPE Alletra 9000 / HPE Primera (previously 3PAR)  data collector to discover inventory and performance for HP 3PAR StoreServ storage arrays.
