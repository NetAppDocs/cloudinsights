...
NOTE: These instructions are being moved to their own page. Please link:task_config_telegraf_agent_k8s.html[go here] for the most up-to-date Kubernetes instructions.
