...
* NetApp Kubernetes Monitoring Operator installation is supported with Kubernetes 1.17 or greater. When used with the Docker container runtime, Cloud Insights can display pod-to-PV-storage mappings for NFS and iSCSI; other runtimes only show iSCSI. 
