...
==== OpenSshift Instructions

If you are running on Openshift 4.x, you must change the "priveleged-mode" setting. Run the following command to open the agent for editing. If you are using a namespace other than "netapp-monitoring", specify that namespace int he command line:
