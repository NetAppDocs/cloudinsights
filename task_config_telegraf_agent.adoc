...
Kubernetes
•	Run `kubectl --namespace monitoring delete ds telegraf-ds`
•	Run `kubectl --namespace monitoring delete rs telegraf-rs`
•	Follow “Steps to install agent on Kubernetes”
