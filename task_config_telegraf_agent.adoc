...
* Operator-based installation has been tested and is expected to work with AWS EKS 1.18, OpenShift 3.11, and Rancher 2.6.
...
==== Configuring Proxy Support for Kubernetes - Operator-Based
