...
. Back up the existing configurations:
 ...
 kubectl --namespace ci-monitoring get cm telegraf-conf -o yaml > /tmp/telegraf-conf.yaml
 kubectl --namespace ci-monitoring get cm telegraf-conf-rs -o yaml > /tmp/telegraf-conf-rs.yaml
