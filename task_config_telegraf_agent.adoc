...
NOTE: The Kubernetes instructions have moved to a new page. Please link:task_config_telegraf_agent_k8s.html[*go here*] for up-to-date Kubernetes agent instructions.
